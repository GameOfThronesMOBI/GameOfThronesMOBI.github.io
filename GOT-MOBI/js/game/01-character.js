...
function getWeaponMasteryBonus(g) {
    ...
    // СКОРОСТЬ от мастерства (1% за 5 уровней)
    var speedBonus = Math.min(65, Math.floor(skillLevel / 5));
    
    // АКТИВНЫЕ (в процентах, до 65% = 325 уровней)
    ...
    // Контратака: после 325 уровня, каждые 5 уровней до 65%
    var counterBonus = 0;
    if (skillLevel > 325) {
...
// ============================================================
// 4. АКТИВНЫЕ БОНУСЫ (очки мастерства)
// ============================================================
