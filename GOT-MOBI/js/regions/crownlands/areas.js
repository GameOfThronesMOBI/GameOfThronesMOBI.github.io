...
const CROWNLANDS_AREAS = {
    ...
    'kl_-4_-5': { id:'kl_-4_-5', name:'Северная опушка', type:'forest', level:30, region:'Королевские земли', area:'Королевская Гавань', owner:'crown', places:['Охотничья тропа'], actions:[], resourceType:'forest', resources:['Дерево','Шкура','Мясо'], zoneNumber:5, x:-4, y:-5 },
    'kl_-3_-5': { id:'kl_-3_-5', name:'Чаща', type:'forest', level:25, region:'Королевские земли', area:'Королевская Гавань', owner:'crown', places:['Волчье логово'], actions:[], resourceType:'forest', resources:['Дерево','Шкура','Мясо'], zoneNumber:5, x:-3, y:-5 },
    ...
    'kl_0_4': { id:'kl_0_4', name:'Мост', type:'road', level:20, region:'Королевские земли', area:'Королевская Гавань', owner:'crown', places:['Пограничный камень'], actions:[], zoneNumber:4, x:0, y:4 },

    // ==================== ЗАПАД — Золотой тракт ====================
    'kl_-5_-4': { id:'kl_-5_-4', name:'Западная чаща', type:'forest', level:30, region:'Королевские земли', area:'Королевская Гавань', owner:'crown', places:['Берлога'], actions:[], resourceType:'forest', resources:['Дерево','Шкура','Мясо'], zoneNumber:4, x:-5, y:-4 },
    'kl_-5_-3': { id:'kl_-5_-3', name:'Западный лес', type:'forest', level:25, region:'Королевские земли', area:'Королевская Гавань', owner:'crown', places:['Лесной лагерь'], actions:[], resourceType:'forest', resources:['Дерево','Шкура','Мясо'], zoneNumber:3, x:-5, y:-3 },
    'kl_-5_-2': { id:'kl_-5_-2', name:'Западная опушка', type:'forest', level:20, region:'Королевские земли', area:'Королевская Гавань', owner:'crown', places:['Старая тропа'], actions:[], resourceType:'forest', resources:['Дерево','Шкура','Мясо'], zoneNumber:2, x:-5, y:-2 },
    'kl_-5_-1': { id:'kl_-5_-1', name:'Западный лес', type:'forest', level:20, region:'Королевские земли', area:'Королевская Гавань', owner:'crown', places:['Старая тропа'], actions:[], resourceType:'forest', resources:['Дерево','Шкура','Мясо'], zoneNumber:1, x:-5, y:-1 },
    ...
    'kl_5_1':  { id:'kl_5_1', name:'Мелководье Чёрноводной', type:'coast', level:20, region:'Королевские земли', area:'Королевская Гавань', owner:'crown', places:['Песчаная коса'], actions:[], resourceType:'shallows', resources:['Рыба','Соль'], zoneNumber:1, x:5, y:1 },
    ...
    'kl_4_4': { id:'kl_4_4', name:'Р. Черноводная', type:'river', level:20, region:'Королевские земли', area:'Королевская Гавань', owner:'crown', places:[], actions:[], resourceType:'river', resources:['Рыба','Вода'], zoneNumber:4, x:4, y:4 },
    ...
    'kl_-2_2':{id:'kl_-2_2',name:'Равнина',type:'plain',level:10,region:'Королевские земли',area:'Королевская Гавань',owner:'crown',places:['Деревня'],actions:[],resourceType:'plain',resources:['Пшеница','Овощи'],zoneNumber:2,x:-2,y:2},
    ...
    // ==================== ЮГО-ЗАПАД — Продолжение Р. Черноводной ====================
    'kl_1_4':{id:'kl_1_4',name:'Р. Черноводная',type:'river',level:20,region:'Королевские земли',area:'Королевская Гавань',owner:'crown',places:[],actions:[],resourceType:'river',resources:['Рыба','Вода'],zoneNumber:4,x:1,y:4},
    'kl_2_4':{id:'kl_2_4',name:'Р. Черноводная',type:'river',level:20,region:'Королевские земли',area:'Королевская Гавань',owner:'crown',places:[],actions:[],resourceType:'river',resources:['Рыба','Вода'],zoneNumber:4,x:2,y:4},
    'kl_3_4':{id:'kl_3_4',name:'Р. Черноводная',type:'river',level:20,region:'Королевские земли',area:'Королевская Гавань',owner:'crown',places:[],actions:[],resourceType:'river',resources:['Рыба','Вода'],zoneNumber:4,x:3,y:4},

    // ==================== СЕВЕРО-ЗАПАД — Королевский лес ====================
    'kl_-1_-1': { id:'kl_-1_-1', name:'Королевский лес: Лесная тропа', type:'forest', level:15, region:'Королевские земли', area:'Королевская Гавань', owner:'crown', places:['Лесосека','Старый дуб'], actions:[], resourceType:'forest', resources:[{name:'Дерево',chance:50}], zoneNumber:1, x:-1, y:-1 },
    ...
    'kl_-5_-5': { id:'kl_-5_-5', name:'Глубь Королевского леса', type:'forest', level:30, region:'Королевские земли', area:'Королевская Гавань', owner:'crown', places:['Древний дуб','Заброшенная хижина'], actions:[], resourceType:'forest', resources:['Дерево','Шкура','Мясо'], zoneNumber:5, x:-5, y:-5 },
