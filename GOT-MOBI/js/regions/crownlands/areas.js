...
const CROWNLANDS_AREAS = {
    ...
    'kl_-5_-5': { id:'kl_-5_-5', name:'Глубь Королевского леса', type:'forest', level:35, region:'Королевские земли', area:'Королевская Гавань', owner:'crown', places:['Древний дуб','Заброшенная хижина'], actions:[], resourceType:'forest', resources:['Дерево','Шкура','Мясо'], zoneNumber:5, x:-5, y:-5 },
